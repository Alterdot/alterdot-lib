# Contributing to alterdot-lib

We're working hard to make _alterdot-lib_ the most powerful JavaScript library for working with Alterdot. Our goal is to have _alterdot-lib_ be a library that can be used by anyone interested in Alterdot, and to level expertise differences with great design and documentation.
...
These are some global design goals in alterdot-lib that any change must adhere.
...
When possible, alterdot-lib objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of alterdot-lib methods. For example, calling `JSON.stringify` on an alterdot-lib object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### T3 - Require 'alterdot' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the alterdot object.

DO:

```javascript
var alterdot = require('../');
var PublicKey = alterdot.PublicKey;
```
...
```sh
git remote add Alterdot git@github.com:Alterdot/alterdot-lib.git
git pull --rebase Alterdot master
```
...
Finally go to [github.com/Alterdot/alterdot-lib](https://github.com/Alterdot/alterdot-lib) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository. We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of alterdot-lib.

If you have any questions feel free to post them to
[github.com/Alterdot/alterdot-lib/issues](https://github.com/Alterdot/alterdot-lib/issues).
