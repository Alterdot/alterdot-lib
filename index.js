...
bitcore.versionGuard = function (version) {
  if (version !== undefined) {
    var message =
      'More than one instance of alterdot-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of alterdot.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._alterdot);
global._alterdot = bitcore.version;
